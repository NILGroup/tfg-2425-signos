...
const Videos = ({videos, isLoading}) => {
    ...
    return (<>{videos && !isLoading && (
      <div className='flex items-center justify-center my-3 lg:mt-8 lg:row-start-2 lg:row-end-4 lg:col-start-2 lg:col-end-3  lg:mr-8'>
          <div className="flex flex-col overflow-y-scroll h-full mx-4 lg:mx-0 max-w-90 lg:max-w-350 xl:max-w-550 max-h-100 md:max-h-130 lg:max-h-135 xl:max-h-180 border-3 md:border-4 border-[#4682A9] rounded-xl 
...
const Video = ({ index, lastIndex, info}) => {
    ...
    return (
        ...
        className={`flex flex-col lg:flex-row
            ...
            <video aria-label={`Representación visual en lengua de signos de "${info.gloss}"`} className='max-h-[200px] max-w-[350px] m-2' loop
                                                     ref={video} >   
